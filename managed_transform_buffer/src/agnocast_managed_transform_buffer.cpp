...
AgnocastManagedTransformBuffer::AgnocastManagedTransformBuffer(
  rcl_clock_type_t clock_type, const bool force_dynamic, tf2::Duration discovery_timeout,
  tf2::Duration cache_time)
{
  provider_ = &AgnocastManagedTransformBufferProvider::getInstance(
    clock_type, force_dynamic, discovery_timeout, cache_time);
}

template <>
std::optional<TransformStamped> AgnocastManagedTransformBuffer::getTransform<TransformStamped>(
...
template <>
std::optional<tf2::Transform> AgnocastManagedTransformBuffer::getTransform<tf2::Transform>(
  const std::string & target_frame, const std::string & source_frame, const tf2::TimePoint & time,
  const tf2::Duration & timeout, const rclcpp::Logger & logger)
{
...
template <>
std::optional<Eigen::Affine3f> AgnocastManagedTransformBuffer::getTransform<Eigen::Affine3f>(
  const std::string & target_frame, const std::string & source_frame, const tf2::TimePoint & time,
  const tf2::Duration & timeout, const rclcpp::Logger & logger)
{
  auto tf = provider_->getTransform(target_frame, source_frame, time, timeout, logger);
...
template <>
std::optional<Eigen::Affine3d> AgnocastManagedTransformBuffer::getTransform<Eigen::Affine3d>(
  const std::string & target_frame, const std::string & source_frame, const tf2::TimePoint & time,
  const tf2::Duration & timeout, const rclcpp::Logger & logger)
{
  auto tf = provider_->getTransform(target_frame, source_frame, time, timeout, logger);
...
template <>
std::optional<Eigen::Matrix4f> AgnocastManagedTransformBuffer::getTransform<Eigen::Matrix4f>(
  const std::string & target_frame, const std::string & source_frame, const tf2::TimePoint & time,
  const tf2::Duration & timeout, const rclcpp::Logger & logger)
{
  auto tf = provider_->getTransform(target_frame, source_frame, time, timeout, logger);
...
template <>
std::optional<Eigen::Matrix4d> AgnocastManagedTransformBuffer::getTransform<Eigen::Matrix4d>(
  const std::string & target_frame, const std::string & source_frame, const tf2::TimePoint & time,
  const tf2::Duration & timeout, const rclcpp::Logger & logger)
{
  auto tf = provider_->getTransform(target_frame, source_frame, time, timeout, logger);
...
AgnocastManagedTransformBuffer::getLatestTransform<TransformStamped>(
...
template <>
std::optional<tf2::Transform> AgnocastManagedTransformBuffer::getLatestTransform<tf2::Transform>(
  const std::string & target_frame, const std::string & source_frame, const rclcpp::Logger & logger)
{
  return getTransform<tf2::Transform>(
    target_frame, source_frame, tf2::TimePointZero, tf2::Duration::zero(), logger);
...
AgnocastManagedTransformBuffer::getLatestTransform<Eigen::Affine3f>(
  const std::string & target_frame, const std::string & source_frame, const rclcpp::Logger & logger)
{
  return getTransform<Eigen::Affine3f>(
    target_frame, source_frame, tf2::TimePointZero, tf2::Duration::zero(), logger);
...
AgnocastManagedTransformBuffer::getLatestTransform<Eigen::Affine3d>(
  const std::string & target_frame, const std::string & source_frame, const rclcpp::Logger & logger)
{
  return getTransform<Eigen::Affine3d>(
    target_frame, source_frame, tf2::TimePointZero, tf2::Duration::zero(), logger);
...
AgnocastManagedTransformBuffer::getLatestTransform<Eigen::Matrix4f>(
  const std::string & target_frame, const std::string & source_frame, const rclcpp::Logger & logger)
{
  return getTransform<Eigen::Matrix4f>(
    target_frame, source_frame, tf2::TimePointZero, tf2::Duration::zero(), logger);
...
AgnocastManagedTransformBuffer::getLatestTransform<Eigen::Matrix4d>(
  const std::string & target_frame, const std::string & source_frame, const rclcpp::Logger & logger)
{
  return getTransform<Eigen::Matrix4d>(
    target_frame, source_frame, tf2::TimePointZero, tf2::Duration::zero(), logger);
...
bool AgnocastManagedTransformBuffer::transformPointcloud(
...
bool AgnocastManagedTransformBuffer::isStatic() const
{
  return provider_->isStatic();
}

rclcpp::Logger AgnocastManagedTransformBuffer::defaultLogger()
{
  return rclcpp::get_logger("agnocast_managed_transform_buffer");
}
